  ...
  describe '#filter' do
    ...
    context 'with valid parameters' do
      context 'with "title_eq=Ruby Under a Microscope"' do
        ...
        it 'gets "Ruby under a Microscope" back' do
      ...
      context 'with "title_notcont=Ruby"' do
        ...
        it 'gets only "agile web development back"' do
      ...
      context 'with "title_start=Ruby"' do
        ...
        it 'gets "Ruby Microscope" and "Ruby on Rails Tutorial" back' do
      ...
      context 'with "title_end=Tutorial"' do
        ...
        it 'gets only "Ruby on Rails Tutorial" back' do
          expect(filtered.first.id).to eq rails_tutorial.id
          expect(filtered.size).to eq 1
        end
      end

      context 'with "released_on_lt2013-05-10"' do
        let(:params) { { 'q' => { 'released_on_lt' => '2013-05-10' } } }

        it 'gets books released on or before "2013-05-10"' do
